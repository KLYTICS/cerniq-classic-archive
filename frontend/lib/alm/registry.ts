...
export type AlmModuleSlug =
  ...
  // rate
  | 'sensitivity' | 'sensitivity-report' | 'yield-curve' | 'market-rates' | 'svensson' | 'hull-white' | 'pca-yield-curve'
...
export const ALM_MODULES: readonly AlmModule[] = [
  ...
  { slug: 'market-rates',        href: '/alm/market-rates',        category: 'rate', tier: 'core',     status: 'ga', icon: Activity,          name: { en: 'Market Rates',         es: 'Tasas de Mercado'        }, description: { en: 'Live FRED macro: yield curve, Fed Funds, Prime, mortgage, CPI, FX', es: 'Macro FRED en vivo: curva, Fed Funds, Prime, hipoteca, CPI, FX' } },
