import { IsNumber, IsString, IsEnum, IsArray, ValidateNested, Min } from 'class-validator';
...
export const STRATEGY_PRESETS: StrategyPresetDto[] = [
    {
        ...
        category: 'bullish',
        legs: [
            { strike: 0, optionType: OptionType.CALL, quantity: 1, buySell: BuySell.BUY },
            { strike: 0, optionType: OptionType.CALL, quantity: 1, buySell: BuySell.SELL },
        ],
    },
    {
        ...
        category: 'bearish',
        legs: [
            { strike: 0, optionType: OptionType.PUT, quantity: 1, buySell: BuySell.BUY },
            { strike: 0, optionType: OptionType.PUT, quantity: 1, buySell: BuySell.SELL },
        ],
    },
    {
        name: 'Long Straddle',
