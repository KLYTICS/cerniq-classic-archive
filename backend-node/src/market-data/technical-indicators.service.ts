...
export class TechnicalIndicatorsService {
    ...
    calculateMACD(
        ...
        const paddingLength = macdLine.findIndex((v) => v !== null) + signalPeriod - 1;
    ...
    calculateStochastic(
        ...
        for (let i = period - 1; i < closes.length; i++) {
            const slice = { high: highs.slice(i - period + 1, i + 1), low: lows.slice(i - period + 1, i + 1) };
        ...
        return {
            ...
            d: [...Array(period + 1).fill(null), ...dValues.filter((v) => v !== null)],
        };
    }
}
