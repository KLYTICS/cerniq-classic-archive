...
export class ExecutionController {
  ...
  async analyzeVWAP(
    ...
    try {
      return await this.executionService.analyzeVWAP(
        execution,
        parseInt(periodMinutes),
      );
    } catch (error: any) {
      throw new HttpException(
  ...
  async generateBestExecutionReport(
    ...
    try {
      return await this.executionService.generateBestExecutionReport(
        body.executions,
        {
  ...
  async calculateImplementationShortfall(@Body() trade: any) {
    try {
      return await this.executionService.calculateImplementationShortfall(
        trade,
      );
    } catch (error: any) {
      throw new HttpException(
