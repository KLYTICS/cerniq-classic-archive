...
export class TickerService {
   ...
   */
  async listTickers(query: TickerListQueryDto): Promise<{
    tickers: TickerDto[];
    total: number;
    page: number;
    limit: number;
  ...
  async updateTicker(
    ...
    if (updateDto.marketCap !== undefined)
      updates.market_cap = updateDto.marketCap;
    if (updateDto.isActive !== undefined)
      updates.is_active = updateDto.isActive;
