...
describe('VintageAnalysisService', () => {
  ...
  it('should calculate loss rates per vintage', () => {
    const result = service.analyze([
      { year: 2020, originalBalance: 100, currentBalance: 80, cumulativeLoss: 5, delinquent: 3 },
      { year: 2021, originalBalance: 120, currentBalance: 100, cumulativeLoss: 3, delinquent: 2 },
      { year: 2022, originalBalance: 150, currentBalance: 140, cumulativeLoss: 2, delinquent: 4 },
    ]);
  ...
  it('should identify worst and best vintage', () => {
    const result = service.analyze([
      { year: 2019, originalBalance: 100, currentBalance: 80, cumulativeLoss: 10, delinquent: 2 },
      { year: 2020, originalBalance: 100, currentBalance: 90, cumulativeLoss: 1, delinquent: 1 },
    ]);
  ...
  it('should compute average loss rate', () => {
    const result = service.analyze([
      { year: 2020, originalBalance: 100, currentBalance: 80, cumulativeLoss: 4, delinquent: 2 },
      { year: 2021, originalBalance: 100, currentBalance: 90, cumulativeLoss: 6, delinquent: 1 },
    ]);
  ...
  it('should compute seasoning from current year', () => {
    ...
    const result = service.analyze([
      { year: currentYear - 3, originalBalance: 100, currentBalance: 80, cumulativeLoss: 5, delinquent: 2 },
    ]);
  ...
  it('should provide bilingual interpretations', () => {
    const result = service.analyze([
      { year: 2020, originalBalance: 100, currentBalance: 90, cumulativeLoss: 3, delinquent: 1 },
    ]);
