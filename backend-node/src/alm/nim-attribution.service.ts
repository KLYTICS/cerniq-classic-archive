      ...
      attribution: [
        {
          ...
          explanation: 'Fed rate changes.',
          explanationEs: 'Cambios Fed.',
        },
        {
          factor: 'Deposit Beta',
          factorEs: 'Beta de Depósitos',
          bps: -7,
          direction: 'negative' as const,
          explanation: 'Deposit repricing.',
          explanationEs: 'Repreciación depósitos.',
        },
        {
          factor: 'Volume Growth',
          ...
          explanation: 'New loans.',
          explanationEs: 'Nuevos préstamos.',
        },
        {
          factor: 'Mix Shift',
          factorEs: 'Mezcla',
        ...
        },
        {
          ...
          bps: -5,
          direction: 'negative' as const,
          explanation: 'Fixed rate lag.',
          explanationEs: 'Rezago tasa fija.',
        },
        {
          factor: 'Prepayment',
          factorEs: 'Prepago',
          bps: -4,
          direction: 'negative' as const,
          explanation: 'Prepayments.',
          explanationEs: 'Prepagos.',
        },
        {
          factor: 'Credit Quality',
          factorEs: 'Crédito',
