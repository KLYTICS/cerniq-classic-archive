...
export const PR_VENDOR_PROFILES: VendorProfile[] = [
  // ── Utilities ──────────────────────────────────────────────────
  {
    ...
    matchKeywords: ['prepa', 'luma', 'luma energy', 'autoridad de energia', 'aee', 'electric', 'electricidad'],
    typicalQuarterlyRange: { p25: 18_000, median: 28_000, p75: 42_000 },
    paymentFrequency: 'Monthly',
    notes: 'Multi-branch cooperativas pay per meter. PR electricity rates ~$0.27/kWh.',
  },
  {
    vendorType: 'UTILITY_WATER',
    displayName: 'AAA (Aqueduct & Sewer)',
    displayNameEs: 'AAA (Acueductos y Alcantarillados)',
    matchKeywords: ['aaa', 'acueductos', 'alcantarillados', 'aqueduct', 'water', 'agua'],
  ...
  },
  {
    ...
    matchKeywords: ['liberty', 'liberty communications', 'liberty cable', 'liberty business'],
  ...
  // ── Regulatory Fees ────────────────────────────────────────────
  {
    ...
    matchKeywords: ['cossec', 'corporacion para la supervision', 'supervision cooperativas'],
  ...
  // ── Insurance ──────────────────────────────────────────────────
  {
    ...
    matchKeywords: ['triple-s', 'triple s', 'triples', 'grupo financiero triple'],
  ...
  },
  {
    ...
    matchKeywords: ['universal insurance', 'universal group', 'universal seguros'],
  ...
  // ── Security Services ──────────────────────────────────────────
  {
    ...
    matchKeywords: ['allied universal', 'g4s', 'allied', 'securitas', 'security', 'seguridad', 'guardia'],
  ...
  // ── Maintenance / HVAC ─────────────────────────────────────────
  {
    ...
    matchKeywords: ['carrier', 'trane', 'hvac', 'aire acondicionado', 'air conditioning', 'climate', 'mantenimiento'],
    typicalQuarterlyRange: { p25: 5_000, median: 12_000, p75: 22_000 },
    paymentFrequency: 'Quarterly',
    notes: 'HVAC maintenance contracts for branch offices. Critical in PR tropical climate.',
  },
];
