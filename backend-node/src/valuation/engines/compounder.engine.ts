...
export class CompounderValuationEngine {
    ...
    async calculate(
        ...
        const peMultiple = this.getQualityAdjustedMultiple(qualityScore, revenueGrowth);
     ...
     */
    private getQualityAdjustedMultiple(qualityScore: number, growth: number): number {
