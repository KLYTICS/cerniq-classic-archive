...
export function resolvePrimaryRoleKey(contactRole: string | null | undefined): string {
...
export function extractMunicipality(location: string | null | undefined): string | null {
