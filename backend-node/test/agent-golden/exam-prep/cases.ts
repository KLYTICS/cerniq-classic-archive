...
export const EXAM_PREP_GOLDEN_CASES: readonly ExamPrepGoldenCase[] = [
  ...
  // ── 4. Multiple WARN categories ──────────────────────────────────────────
  {
    ...
    expectedOutput: {
      ...
      mustIncludeRecommendations: ['duration', 'earnings', 'governance', 'board'],
    },
  ...
  // ── 7. Mixed: 3 FAIL + 2 WARN + 1 PASS ─────────────────────────────────
  {
    ...
    expectedOutput: {
      ...
      mustIncludeRecommendations: ['liquidity', 'capital', 'delinquency', 'remediation'],
    },
  ...
  // ── 8. NII Sensitivity at 36% (just above FAIL) ─────────────────────────
  {
    ...
    expectedOutput: {
      ...
      mustIncludeRecommendations: ['NII', 'sensitivity', 'hedge', 'interest rate'],
    },
  ...
  // ── 9. First-time assessment with no prior data ──────────────────────────
  {
    ...
    expectedOutput: {
      ...
      mustIncludeRecommendations: ['baseline', 'policy', 'governance', 'documentation'],
    },
